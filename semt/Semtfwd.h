 ...
 * and supply operator<< for it if not SEMT_DISABLE_PRINT.
 */
...
/*!
 * Omit all headers & methods related to string-output.
 */
#ifndef SEMT_DISABLE_PRINT
